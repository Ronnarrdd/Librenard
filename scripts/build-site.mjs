...
const pages = [
    ...
    },
    {
        ...
        description: 'Outils libres auto-hébergés par Librenard : Etherpad (édition collaborative), Draw.io (diagrammes), Piped (alternative YouTube) et BentoPDF (manipulation PDF). Gratuits, sans pub et sans pistage.',
        keywords: 'Etherpad, Draw.io, Piped, BentoPDF, PDF, outils libres, auto-hébergement, vie privée, alternatives libres',
        ogTitle: 'Outils libres - Librenard',
        ogDescription: 'Etherpad, Draw.io, Piped, BentoPDF… des services libres et respectueux de la vie privée, mis à disposition gratuitement.',
        twitterTitle: 'Outils libres - Librenard',
        twitterDescription: 'Etherpad, Draw.io, Piped, BentoPDF — outils libres gratuits et respectueux de la vie privée.',
